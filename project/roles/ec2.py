...
variables needed for Boto have already been set:
    export AWS_ACCESS_KEY_ID='AKIASM343RWKQYVA4ZX4'
    export AWS_SECRET_ACCESS_KEY='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'
...
the AWS_PROFILE variable:
    ...
    AWS_PROFILE=prod ansible-playbook -i ec2.py myapp.yml
...
with 'webserver', one might use:
    ...
    export EC2_INSTANCE_FILTERS='tag:Name=webservers'
...
'my_instance': {
    'region': 'ap-southeast-1',             # attribute
    'availability_zone': 'ap-southeast-1a', # attribute
